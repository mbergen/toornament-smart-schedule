...
export interface MatchDetailedAllOf {
     ...
     */
    'report_status': MatchDetailedAllOfReportStatusEnum;
    /**
     * List of the opponents involved in this match.
     * @type {Array<OpponentDetailed>}
     * @memberof MatchDetailedAllOf
...
export const MatchDetailedAllOfReportStatusEnum = {
    Report: 'report',
    Dispute: 'dispute'
} as const;

export type MatchDetailedAllOfReportStatusEnum = typeof MatchDetailedAllOfReportStatusEnum[keyof typeof MatchDetailedAllOfReportStatusEnum];
...
export const OrganizerMatchesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        matchesGet: async (range: string, stageIds?: Array<string>, stageNumbers?: Array<number>, groupIds?: Array<string>, groupNumbers?: Array<number>, roundIds?: Array<string>, roundNumbers?: Array<number>, statuses?: Array<string>, isScheduled?: boolean, scheduledBefore?: string, scheduledAfter?: string, playedBefore?: string, playedAfter?: string, disciplines?: Array<string>, tournamentIds?: Array<string>, participantIds?: Array<string>, customUserIdentifiers?: Array<string>, matchIds?: Array<string>, sort?: 'structure' | 'schedule' | 'latest_results', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {string} id The id of the requested custom field.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const OrganizerMatchesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async matchesGet(range: string, stageIds?: Array<string>, stageNumbers?: Array<number>, groupIds?: Array<string>, groupNumbers?: Array<number>, roundIds?: Array<string>, roundNumbers?: Array<number>, statuses?: Array<string>, isScheduled?: boolean, scheduledBefore?: string, scheduledAfter?: string, playedBefore?: string, playedAfter?: string, disciplines?: Array<string>, tournamentIds?: Array<string>, participantIds?: Array<string>, customUserIdentifiers?: Array<string>, matchIds?: Array<string>, sort?: 'structure' | 'schedule' | 'latest_results', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<MatchFully>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.matchesGet(range, stageIds, stageNumbers, groupIds, groupNumbers, roundIds, roundNumbers, statuses, isScheduled, scheduledBefore, scheduledAfter, playedBefore, playedAfter, disciplines, tournamentIds, participantIds, customUserIdentifiers, matchIds, sort, options);
...
export const OrganizerMatchesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        matchesGet(range: string, stageIds?: Array<string>, stageNumbers?: Array<number>, groupIds?: Array<string>, groupNumbers?: Array<number>, roundIds?: Array<string>, roundNumbers?: Array<number>, statuses?: Array<string>, isScheduled?: boolean, scheduledBefore?: string, scheduledAfter?: string, playedBefore?: string, playedAfter?: string, disciplines?: Array<string>, tournamentIds?: Array<string>, participantIds?: Array<string>, customUserIdentifiers?: Array<string>, matchIds?: Array<string>, sort?: 'structure' | 'schedule' | 'latest_results', options?: any): AxiosPromise<Array<MatchFully>> {
            return localVarFp.matchesGet(range, stageIds, stageNumbers, groupIds, groupNumbers, roundIds, roundNumbers, statuses, isScheduled, scheduledBefore, scheduledAfter, playedBefore, playedAfter, disciplines, tournamentIds, participantIds, customUserIdentifiers, matchIds, sort, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves a match identified by the given id. If the match type is \"ffa\", a match returns a maximum of 100 opponents.
         * @summary Retrieves a match.
...
export class OrganizerMatchesApi extends BaseAPI {
     ...
     */
    public matchesGet(range: string, stageIds?: Array<string>, stageNumbers?: Array<number>, groupIds?: Array<string>, groupNumbers?: Array<number>, roundIds?: Array<string>, roundNumbers?: Array<number>, statuses?: Array<string>, isScheduled?: boolean, scheduledBefore?: string, scheduledAfter?: string, playedBefore?: string, playedAfter?: string, disciplines?: Array<string>, tournamentIds?: Array<string>, participantIds?: Array<string>, customUserIdentifiers?: Array<string>, matchIds?: Array<string>, sort?: 'structure' | 'schedule' | 'latest_results', options?: AxiosRequestConfig) {
        return OrganizerMatchesApiFp(this.configuration).matchesGet(range, stageIds, stageNumbers, groupIds, groupNumbers, roundIds, roundNumbers, statuses, isScheduled, scheduledBefore, scheduledAfter, playedBefore, playedAfter, disciplines, tournamentIds, participantIds, customUserIdentifiers, matchIds, sort, options).then((request) => request(this.axios, this.basePath));
    }
