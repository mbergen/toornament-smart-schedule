...
export interface CircuitRegion {
    /**
     * The id of the circuit region.
     * @type {string}
     * @memberof CircuitRegion
     */
    'id': string;
    /**
     * The name of the circuit region.
     * @type {string}
     * @memberof CircuitRegion
     */
    'name': string;
    /**
     * A name used to identify a circuit region.
     * @type {string}
     * @memberof CircuitRegion
     */
    'machine_name': string;
 ...
 * 
 * @export
 * @interface CircuitSeason
 */
export interface CircuitSeason {
    /**
     * The id of the circuit season.
     * @type {string}
     * @memberof CircuitSeason
     */
    'id': string;
    /**
     * The name of the circuit season.
     * @type {string}
     * @memberof CircuitSeason
     */
    'name': string;
    /**
     * A name used to identify a circuit season.
     * @type {string}
     * @memberof CircuitSeason
     */
    'machine_name': string;
 ...
 * 
 * @export
 * @interface CircuitTier
 */
export interface CircuitTier {
    /**
     * The id of the circuit tier.
     * @type {string}
     * @memberof CircuitTier
     */
    'id': string;
    /**
     * The name of the circuit tier.
     * @type {string}
     * @memberof CircuitTier
     */
    'name': string;
    /**
     * A name used to identify a circuit tier.
     * @type {string}
     * @memberof CircuitTier
     */
    'machine_name': string;
...
export interface TournamentDetailedSingle {
    ...
    /**
     * 
     * @type {CircuitSeason & object}
     * @memberof TournamentDetailedSingle
     */
    'circuit_season': CircuitSeason & object;
    /**
     * 
     * @type {CircuitRegion & object}
     * @memberof TournamentDetailedSingle
     */
    'circuit_region': CircuitRegion & object;
    /**
     * 
     * @type {CircuitTier & object}
     * @memberof TournamentDetailedSingle
     */
    'circuit_tier': CircuitTier & object;
}
...
export const OrganizerTournamentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        tournamentsGet: async (range: string, disciplines?: string, statuses?: 'pending' | 'running' | 'completed', scheduledBefore?: string, scheduledAfter?: string, countries?: string, platforms?: 'pc' | 'playstation4' | 'xbox_one' | 'nintendo_switch' | 'mobile' | 'playstation3' | 'playstation2' | 'playstation1' | 'ps_vita' | 'psp' | 'xbox360' | 'xbox' | 'wii_u' | 'wii' | 'gamecube' | 'nintendo64' | 'snes' | 'nes' | 'dreamcast' | 'saturn' | 'megadrive' | 'master_system' | '3ds' | 'ds' | 'game_boy' | 'neo_geo' | 'other_platform' | 'not_video_game', isOnline?: 0 | 1, archived?: 0 | 1, customUserIdentifier?: string, tournamentIds?: Array<string>, circuitIds?: Array<string>, circuitSeasons?: string, circuitRegions?: string, circuitTiers?: string, sort?: 'scheduled_asc' | 'scheduled_desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const OrganizerTournamentsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async tournamentsGet(range: string, disciplines?: string, statuses?: 'pending' | 'running' | 'completed', scheduledBefore?: string, scheduledAfter?: string, countries?: string, platforms?: 'pc' | 'playstation4' | 'xbox_one' | 'nintendo_switch' | 'mobile' | 'playstation3' | 'playstation2' | 'playstation1' | 'ps_vita' | 'psp' | 'xbox360' | 'xbox' | 'wii_u' | 'wii' | 'gamecube' | 'nintendo64' | 'snes' | 'nes' | 'dreamcast' | 'saturn' | 'megadrive' | 'master_system' | '3ds' | 'ds' | 'game_boy' | 'neo_geo' | 'other_platform' | 'not_video_game', isOnline?: 0 | 1, archived?: 0 | 1, customUserIdentifier?: string, tournamentIds?: Array<string>, circuitIds?: Array<string>, circuitSeasons?: string, circuitRegions?: string, circuitTiers?: string, sort?: 'scheduled_asc' | 'scheduled_desc', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Tournament>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.tournamentsGet(range, disciplines, statuses, scheduledBefore, scheduledAfter, countries, platforms, isOnline, archived, customUserIdentifier, tournamentIds, circuitIds, circuitSeasons, circuitRegions, circuitTiers, sort, options);
...
export const OrganizerTournamentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        tournamentsGet(range: string, disciplines?: string, statuses?: 'pending' | 'running' | 'completed', scheduledBefore?: string, scheduledAfter?: string, countries?: string, platforms?: 'pc' | 'playstation4' | 'xbox_one' | 'nintendo_switch' | 'mobile' | 'playstation3' | 'playstation2' | 'playstation1' | 'ps_vita' | 'psp' | 'xbox360' | 'xbox' | 'wii_u' | 'wii' | 'gamecube' | 'nintendo64' | 'snes' | 'nes' | 'dreamcast' | 'saturn' | 'megadrive' | 'master_system' | '3ds' | 'ds' | 'game_boy' | 'neo_geo' | 'other_platform' | 'not_video_game', isOnline?: 0 | 1, archived?: 0 | 1, customUserIdentifier?: string, tournamentIds?: Array<string>, circuitIds?: Array<string>, circuitSeasons?: string, circuitRegions?: string, circuitTiers?: string, sort?: 'scheduled_asc' | 'scheduled_desc', options?: any): AxiosPromise<Array<Tournament>> {
            return localVarFp.tournamentsGet(range, disciplines, statuses, scheduledBefore, scheduledAfter, countries, platforms, isOnline, archived, customUserIdentifier, tournamentIds, circuitIds, circuitSeasons, circuitRegions, circuitTiers, sort, options).then((request) => request(axios, basePath));
        },
        /**
         * Deletes your tournament identified by the given id.
         * @summary Delete one of your tournaments.
...
export class OrganizerTournamentsApi extends BaseAPI {
     ...
     */
    public tournamentsGet(range: string, disciplines?: string, statuses?: 'pending' | 'running' | 'completed', scheduledBefore?: string, scheduledAfter?: string, countries?: string, platforms?: 'pc' | 'playstation4' | 'xbox_one' | 'nintendo_switch' | 'mobile' | 'playstation3' | 'playstation2' | 'playstation1' | 'ps_vita' | 'psp' | 'xbox360' | 'xbox' | 'wii_u' | 'wii' | 'gamecube' | 'nintendo64' | 'snes' | 'nes' | 'dreamcast' | 'saturn' | 'megadrive' | 'master_system' | '3ds' | 'ds' | 'game_boy' | 'neo_geo' | 'other_platform' | 'not_video_game', isOnline?: 0 | 1, archived?: 0 | 1, customUserIdentifier?: string, tournamentIds?: Array<string>, circuitIds?: Array<string>, circuitSeasons?: string, circuitRegions?: string, circuitTiers?: string, sort?: 'scheduled_asc' | 'scheduled_desc', options?: AxiosRequestConfig) {
        return OrganizerTournamentsApiFp(this.configuration).tournamentsGet(range, disciplines, statuses, scheduledBefore, scheduledAfter, countries, platforms, isOnline, archived, customUserIdentifier, tournamentIds, circuitIds, circuitSeasons, circuitRegions, circuitTiers, sort, options).then((request) => request(this.axios, this.basePath));
    }
